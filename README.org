...
to [[https://usaoc.github.io/for/][the manual]].
...
* Contribute
  [[https://github.com/usaoc/for/issues][Submit an issue]] for bug reports and general discussion.  [[https://github.com/usaoc/for/pulls][Submit a
